...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './theatres.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEATRES_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEATRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEATRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEATRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEATRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEATRES actions', async () => {
      const expectedActions = [
        {
