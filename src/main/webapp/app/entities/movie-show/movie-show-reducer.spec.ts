...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOVIESHOW_LIST actions', async () => {
    ...
    it('dispatches FETCH_MOVIESHOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOVIESHOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOVIESHOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOVIESHOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOVIESHOW actions', async () => {
      const expectedActions = [
        {
